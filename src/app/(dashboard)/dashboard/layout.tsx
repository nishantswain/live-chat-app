import FriendRequestsSidebarOptions from '@/app/components/FriendRequestsSidebarOptions';
import { Icons, Icon } from '@/app/components/Icons';
...
const Layout = async ({ children }: LayoutProps) => {
  ...
  return (
    <div className="w-full flex h-screen ">
      ...
      <div className="hidden md:flex h-full w-full max-w-xs grow flex-col gap-y-5 overflow-y-auto border-r border-gray-20 bg-white px-6">
